...
public interface Definition extends Resolvable {

	List<Symbol> getDeclaredSymbols();

	default Definition resolved(final IdlElement scope, final SymbolResolver resolver) {
		return this;
	}
}
