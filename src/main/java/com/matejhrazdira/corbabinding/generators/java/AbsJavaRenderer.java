...
public abstract class AbsJavaRenderer implements JavaProjectionProvider {
	...
	private void writeElementStart(final LineWriter writer, final ScopedName name) throws IOException {
		writer.writeln("public ", getElementType(), " ", name.getBaseName(), " ", "{");
		writer.writeln();
	}
